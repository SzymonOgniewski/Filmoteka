import { showSearchMovies } from './search';

const pagination = document.querySelector('.pagination-container');

let currentPage;

const showSearchPagination = (query, currPage, totalPages) => {
  ...
  prevBtn.addEventListener('click', e => {
    ...
    showSearchPagination(currentPage);
  });
  ...
  firstBtn.addEventListener('click', e => {
    ...
    showSearchMovies(query, currentPage);
  });
